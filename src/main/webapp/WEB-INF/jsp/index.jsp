...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="#">LOVESCALAD</a>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <!-- Title -->
            <h1 class="mt-4">Topo de la semaine</h1>
            ...
            <hr>
            <!-- Date/Time -->
            <p>Posté le 4 Avril 2019 à 2h34</p>
            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Rechercher sur...">
